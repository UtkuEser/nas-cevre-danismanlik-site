      ...
      <div className="bg-[#F7F7F5] border-b border-[#E2E2E2]">
        <div className="max-w-[1200px] mx-auto px-6 py-12 md:py-16">
          <nav className="flex items-center gap-2 text-xs text-[#8A8A8A] mb-6" style={{ fontFamily: "Inter, sans-serif" }}>
            ...
            <span>/</span>
            <span className="text-[#4B4B4B]">Blog</span>
            <span>/</span>
          ...
          <div className="flex items-center gap-4 text-[#8A8A8A] text-sm" style={{ fontFamily: "Inter, sans-serif" }}>
            <span>{new Date(post.publishDate).toLocaleDateString("tr-TR", { year: "numeric", month: "long", day: "numeric" })}</span>
            <span>·</span>
